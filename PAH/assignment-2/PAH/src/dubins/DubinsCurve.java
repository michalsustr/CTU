...
public class DubinsCurve {
	...
	private Euclidean2dYawPoint start;
	private double rho;
	 ...
	 */
	public DubinsCurve(Euclidean2dYawPoint start, Euclidean2dYawPoint end, double rho) {
		this(start, end, rho, false);
	}

	/**
	 * Creates anew Dubins curve.
	 * @param start start point with tangential vector
	 * @param end target point with tangential vector
	 * @param rho turn radius
	 * @param reverseAllowed if true, the shorter from forward/reverse curved will be constructed.
	 */
    public DubinsCurve(Euclidean2dYawPoint start, Euclidean2dYawPoint end, double rho, boolean reverseAllowed) {
        this.start = start;
        this.rho = rho;
	...
	protected DubinsPath getDubinsPath(Euclidean2dYawPoint start, Euclidean2dYawPoint end, double rho) {
    ...
    public Euclidean2dYawPoint[] interpolateAdaptiveBy(double samplingInterval) {
    	List<Euclidean2dYawPoint> points = new LinkedList<Euclidean2dYawPoint>();
    	...
    	return points.toArray(new Euclidean2dYawPoint[points.size()]);
    }

	protected List<Euclidean2dYawPoint> interpolateSegment(int i, double samplingInterval, boolean isReverse) {
    ...
    public Euclidean2dYawPoint[] interpolateUniformBy(double samplingInterval) {

		int nSamples = (int) Math.ceil(getLength() / samplingInterval);
		Euclidean2dYawPoint[] res = new Euclidean2dYawPoint[nSamples+1];
    ...
    public Euclidean2dYawPoint interpolate(double t)
    {
        double seg = t * path.length();
        double phi = start.getYaw();
        double v;

        Euclidean2dYawPoint s = new Euclidean2dYawPoint(0, 0, start.getYaw());
        ...
        Euclidean2dYawPoint res = new Euclidean2dYawPoint(s.x * rho + start.x, s.y * rho + start.y, s.getYaw());
        return res;
    }
