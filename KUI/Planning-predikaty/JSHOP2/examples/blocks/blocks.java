...
class Precondition0 extends Precondition
{
	...
	public Precondition0(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(5, 1, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 1, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 1);
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(7, 1, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 1);
		b = new Term[3][];
...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(5, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(1), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), unifier), 2);
		p[3] = new PreconditionNegation(new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), unifier), 2);
		b = new Term[4][];
...
class Precondition2 extends Precondition
{
	...
	public Precondition2(Term[] unifier)
	{
		...
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		p[2] = new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(1), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), unifier);
		p[3] = new PreconditionNegation(new PreconditionAtomic(new Predicate(8, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		b = new Term[4][];
...
class Precondition3 extends Precondition
{
	...
	public Precondition3(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		p[2] = new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), unifier);
		p[3] = new PreconditionNegation(new PreconditionAtomic(new Predicate(9, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier), 2);
		p[4] = new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		p[5] = new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		b = new Term[6][];
...
class Precondition4 extends Precondition
{
	...
	public Precondition4(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), TermList.NIL))), TermList.NIL)), unifier);
...
class Precondition5 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[0] = new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
...
class Precondition6 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[0] = new PreconditionAtomic(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), unifier);
		p[1] = new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		p[2] = new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		b = new Term[3][];
...
class Precondition7 extends Precondition
{
	...
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(8, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[1] = new PreconditionAtomic(new Predicate(3, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		b = new Term[2][];
...
class Precondition9 extends Precondition
{
	...
	public Precondition9(Term[] unifier)
	{
		...
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(10, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier), 4);
		b = new Term[3][];
...
class Precondition13 extends Precondition
{
	...
	public Precondition13(Term[] unifier)
	{
		...
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(10, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier), 4);
		b = new Term[3][];
