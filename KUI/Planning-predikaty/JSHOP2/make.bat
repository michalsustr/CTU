...
:Run11
  cd ulohy
  java JSHOP2.InternalDomain monkeydomain
  java JSHOP2.InternalDomain -ra monkeyproblem
  javac monkeyproblem.java
  java monkeyproblem
  del monkeydomain.java
  del monkeydomain.txt
  del monkeyproblem.java
  del *.class
  cd ..
  goto :End
...
:Run12
  cd ulohy
  java JSHOP2.InternalDomain traveldomain
  java JSHOP2.InternalDomain -ra travelproblem
  javac travelproblem.java
  java travelproblem
  del traveldomain.java
  del traveldomain.txt
  del travelproblem.java
  del *.class
  cd ..
  goto :End
