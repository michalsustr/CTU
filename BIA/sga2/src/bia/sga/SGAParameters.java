...
public class SGAParameters extends Properties {
    ...
    private String functionName = "bia.sga.DistanceFunction"; // fitness function class name
    private ContinuousFunction function = null; // fitness function
    private int genesPerValue=10;      // chromosome size
    ...
    private int crossType = 2;      // crossover type

    private double pC = 0.2;       // crossover probability
    private double pM = 0.6;        // big mutation probability
    private double pSM = 0.8;       // small mutation probability
    ...
    public void readConfigFile() throws Exception {
        ...
        try {
            functionName = this.getProperty("function", "bia.sga.ExampleFunction");
        } catch (Exception e) {
    ...
    public void setGenesPerValue(int genesPerValue) {
        this.genesPerValue = genesPerValue;
    }
