...
public class Individual {
    ...
    public boolean isAlive() {
        return (mFraction >= SimParams.minSpeciesIndividualFraction && mAge < SGA.maxAge);
    }
    ...
    public void geneDuplicationMutation() {
        if(mGenes[0].length == SimParams.maxGenomeLength) return;
    ...
    public String toString() {
        return "I{"+ mAge + ", "+ mGenesString + ", "+getFraction()+"}";
    }
