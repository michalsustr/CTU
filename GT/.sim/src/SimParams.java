...
public class SimParams {
    ...
    public static double pPM = 0.1;               // probability of point mutation
    public static double pGDM = 0.025;              // probability of gene duplication mutation
    ...
    public static int maxGenomeLength_2 = 6; // maximum genomre length in the exponent of power of 2
    public static int maxGenomeLength = (int) Math.pow(2, maxGenomeLength_2);
    public static double k[]={0.4,0.6,1};
