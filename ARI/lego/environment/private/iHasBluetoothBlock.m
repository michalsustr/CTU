...
RxBlk = find_system(appSubsystem, 'regexp', 'on', ...
    'BlockType', 'S-Function', ...
    'MaskType', 'Bluetooth Rx Read');
TxBlk = find_system(appSubsystem, 'regexp', 'on', ...
    'BlockType', 'S-Function', ...
    'MaskType', 'Bluetooth Tx Write');
LoggerBlk = find_system(appSubsystem, 'regexp', 'on', ...
    'BlockType', 'S-Function', ...
    'MaskType', 'NXT GamePad Data Logger');
ADCLoggerBlk = find_system(appSubsystem, 'regexp', 'on', ...
    'BlockType', 'S-Function', ...
