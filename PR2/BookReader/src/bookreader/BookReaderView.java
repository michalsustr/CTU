 ...
 */
public class BookReaderView extends FrameView {

    public BookReaderView(SingleFrameApplication app) {
        super(app);
...
/*
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = BookReaderApp.getApplication().getMainFrame();
            aboutBox = new BookReaderAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        BookReaderApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        jSplitPane1.setTopComponent(renderPanel);
        ...
        inputText.setRows(3);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(bookreader.BookReaderApp.class).getContext().getResourceMap(BookReaderView.class);
        inputText.setText(resourceMap.getString("inputText.text")); // NOI18N
        inputText.setToolTipText(resourceMap.getString("inputText.toolTipText")); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(bookreader.BookReaderApp.class).getContext().getActionMap(BookReaderView.class, this);
        ...
        statusPanel.setPreferredSize(new java.awt.Dimension(400, 41));
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .addGroup(statusPanelLayout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(statusMessageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void renderInputText() {
		TextPanel textPanel = (TextPanel)renderPanel;
		textPanel.setText(inputText.getText());
	}
